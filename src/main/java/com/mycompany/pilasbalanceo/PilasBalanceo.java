...
public class PilasBalanceo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Archivo " + file1 +  " Contiene Errores: " + balancerFile1);

        String file2 = "texto2.txt";
        String contentFile2 = readFileContent(file2);
        boolean balancerFile2 = checkParenthesis(contentFile2);
        System.out.println("Archivo " + file2 + " Contiene Errores: " + balancerFile2);
    }
